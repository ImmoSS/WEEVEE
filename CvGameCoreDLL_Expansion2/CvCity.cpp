...
#ifdef WEEVEE_AVAILABLE_TO_BUILD_BUILDINGS_ALLOWED_BY_BELIEFS
	ReligionTypes eMajority = GetCityReligions()->GetReligiousMajority();
	const CvReligion* pReligion = GC.getGame().GetGameReligions()->GetReligion(eMajority, getOwner());
	if(pkBuildingInfo->IsUnlockedByBelief() && (pReligion == NULL || !pReligion->m_Beliefs.IsBuildingClassEnabled((BuildingClassTypes)pkBuildingInfo->GetBuildingClassType())))
	{
		return false;
	}
#endif
