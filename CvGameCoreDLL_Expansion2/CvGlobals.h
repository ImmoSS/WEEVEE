...
public:
	...
	GD_INT_DEF(NEW_SCORE_LAND_MULTIPLIER);
	GD_INT_DEF(NEW_SCORE_RELIGION_CITIES_MULTIPLIER);
...
#endif
#ifdef NQM_OPTIONAL_SCORING_TWEAKS
	GD_INT_DECL(NEW_SCORE_LAND_MULTIPLIER);
	GD_INT_DECL(NEW_SCORE_RELIGION_CITIES_MULTIPLIER);
